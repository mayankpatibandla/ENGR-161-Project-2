            ...
            for filter_name, filter_data in data["filters"].items():
                ...
                for distiller_name, distiller_data in data["distillers"].items():
                    ...
                    for dehydrator_name, dehydrator_data in data["filters"].items():
                        ...
                        output.append((dehydrator_out, grade, fermenter_out["mass_sugar"], dehydrator_out["mass_sugar"], distiller_in["mass_ethanol"], distiller_in["mass_water"], distiller_in["mass_fiber"], fermenter_in["mass"], distiller_in["volumetric_flow_out"], dehydrator_out["volumetric_flow_out"], fermenter_in["volumetric_flow_in"] * dehydrator_out["cost"]))
